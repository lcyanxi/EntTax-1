...
import com.douguo.dc.applog.dao.AppMauDao;
...
@Repository("appMauService")
public class AppMauService {

    @Autowired
    private AppMauDao appMauDao;

    @Autowired
    private TrendsDao trendsDao;

    public List<Map<String, Object>> querySumListByApp(String startDate, String endDate, String appId) {
        List<Map<String, Object>> keyRows = appMauDao.querySumListByApp(startDate, endDate, appId);
        return keyRows;
    }

    public List<Map<String, Object>> querySumList(String startDate, String endDate) {
        List<Map<String, Object>> keyRows = appMauDao.querySumList(startDate, endDate);
        return keyRows;
    }

    public List<Map<String, Object>> querySumListAll(String startDate, String endDate) {
        List<Map<String, Object>> keyRows = appMauDao.querySumListAll(startDate, endDate);
        return keyRows;
    }
    ...
    public List<Map<String, Object>> queryChannelListByApp(String startDate, String endDate, String appId,
        ...
        List<Map<String, Object>> keyRows = appMauDao.queryChannelListByApp(startDate, endDate, appId, channel, vers);
        return keyRows;
    }
    ...
    public List<Map<String, Object>> queryChannelQualityListByApp(String startDate, String endDate, String appId,
                                                                  String channel) {
        List<Map<String, Object>> keyRows = appMauDao.queryChannelQualityListByApp(startDate, endDate, appId, channel);
        return keyRows;
    }
    ...
    public List<Map<String, Object>> queryVersListByApp(String startDate, String endDate, String appId) {
        List<Map<String, Object>> keyRows = appMauDao.queryVersListByApp(startDate, endDate, appId);
        return keyRows;
    }
    ...
    public List<Map<String, Object>> queryChannelList(String startDate, String endDate, String app) {
        List<Map<String, Object>> keyRows = appMauDao.queryChannelList(startDate, endDate, app);
        return keyRows;
    }
    ...
    public List<Map<String, Object>> queryActiveUserTotal(String startDate, String endDate, String... app) {
        return appMauDao.queryActiveUserTotal(startDate, endDate, app);
    }
}
