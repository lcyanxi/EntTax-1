...
@Repository("appDauDao")
public class AppDauDao {
    @Autowired
    private JdbcTemplate jdbcTemplate;

    public List<Map<String, Object>> querySumListByApp(String startDate, String endDate, String appId) {
        String sql = "SELECT statdate,app,sum(imei) as imei,sum(euid) as euid,sum(uid) as uid,sum(logins) as logins FROM `dd_app_dau_stat` WHERE app= ? AND statdate BETWEEN ? AND ? GROUP BY statdate,app ORDER BY statdate,app desc";
    ...
    public List<Map<String, Object>> querySumList(String startDate, String endDate) {
        String sql = "SELECT statdate,app,sum(imei) as imei,sum(euid) as euid,sum(uid) as uid,sum(logins) as logins FROM `dd_app_dau_stat` WHERE statdate BETWEEN ? AND ? GROUP BY statdate,app ORDER BY statdate,app desc";
    ...
    public List<Map<String, Object>> querySumListAll(String startDate, String endDate) {
        String sql = "SELECT statdate,'ALL' as app,sum(imei) as imei,sum(euid) as euid,sum(uid) as uid,sum(logins) as logins FROM `dd_app_dau_stat` WHERE statdate BETWEEN ? AND ? GROUP BY statdate ORDER BY statdate asc";
        Util.showSQL(sql, new Object[]{startDate, endDate});
        List<Map<String, Object>> rowlst = jdbcTemplate.queryForList(sql, new Object[]{startDate, endDate});
        return rowlst;
    }
    ...
    public List<Map<String, Object>> queryChannelListByApp(String startDate, String endDate, String appId,
        ...
        String sql = "SELECT statdate,app,channel,sum(imei) as imei,sum(euid) as euid,sum(uid) as uid,sum(logins) as logins FROM `dd_app_dau_stat` WHERE app= ? AND statdate BETWEEN ? AND ? ";
    ...
    public List<Map<String, Object>> queryChannelList(String startDate, String endDate, String app) {
        String sql = "SELECT statdate,app,channel,sum(imei) as imei,sum(euid) as euid,sum(uid) as uid,sum(logins) as logins FROM `dd_app_dau_stat` WHERE statdate BETWEEN ? AND ? ";
        List<String> listParm = new ArrayList<String>();
        listParm.add(startDate);
        listParm.add(endDate);
    ...
    public List<Map<String, Object>> queryChannelQualityListByApp(String startDate, String endDate, String appId,
        ...
        String sql = "select nt.*,(nt.cs/nt.uid) as rs "
                ...
                + "				from dd_app_dau_stat where app = ? and statdate BETWEEN ? AND ? group by statdate,channel"
