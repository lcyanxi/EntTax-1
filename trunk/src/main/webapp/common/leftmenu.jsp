...
<body>
  ...
  <div style="padding:10px;"> 
	  <div class="demo" style="height:100%">
	    ...
	    <div id="menuDiv" name="menuDiv" style="border-bottom: #c3daf9 1px solid; border-left: #c3daf9 1px solid; width: 197px;height:100%; overflow: auto; border-top: #c3daf9 1px solid; border-right: #c3daf9 1px solid;">
	        <div id="tree">
