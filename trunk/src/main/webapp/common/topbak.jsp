...
<link type="text/css" href="/styles/common.css" rel="stylesheet" />
	...
	function  goinit(){
	    ...
	    function openMangeIndex() {
	        ...
	        //mainFrameset.cols = "0,*";
	        top.frames["main"].location.replace("/admin/userManage.jsp");
	    }
	...
	<div class="navL">
		<div class="navR">
			<ul>
				...
				<li><a name="display_menu" href="#" onclick="showSupportStaffManage();displayMenu(this)" >全网数据</a></li>
				<li><a name="display_menu" href="#" onclick="showCKGL();displayMenu(this)">主站数据</a></li>
				<li><a name="display_menu" href="#" onclick="showYWGL();displayMenu(this)">无线数据</a></li>
				<li><a name="display_menu" href="#" onclick="showFZXS();displayMenu(this)">其他数据</a></li>
