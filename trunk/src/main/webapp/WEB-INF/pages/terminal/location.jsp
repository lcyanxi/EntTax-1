...
<div class="bd clearfix">
	...
	<jsp:include page="../includes/left_menu.jsp">
		...
		<jsp:param name="menu2" value="Location" />
	</jsp:include>

	<div id="mainContainer">
		<div class="contentCol">
			<input type="hidden" value="devices_location" id="action_stats" />
			...
			<div class="mod mod1">
				<div class="mod-header radius clearfix">
					<h2>
						Top 10 省市<a class="icon help poptips" action-frame="tip_devices" title=""></a>
					</h2>
				</div>
				<div class="mod-body">
					<div class="content">
			...
			<div class="">
				<div id="tip_device">
					<div id="tip_devices" class="tips">
						...
						<p>您可以查看在指定日期内(活跃用户、启动次数)省份的分布情况。</p>
					</div>
				</div>
			</div>
		</div>
