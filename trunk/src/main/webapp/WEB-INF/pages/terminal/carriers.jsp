...
<div class="bd clearfix">
	...
	<div id="mainContainer">
		<div class="contentCol">
			<input type="hidden" value="devices_carriers" id="action_stats" />
						...
						<div class="mod-select">
							<div class="tabpanel">
								<ul id="toptab" class="borders">
									<li class=><a href="/terminal/device.do?appId=${globalAppid }&which=network">联网方式</a></li>
									<li class=on><a href="/terminal/device.do?appId=${globalAppid }&which=carriers">运营商</a></li>
								</ul>
							</div>
						</div>
					</div>
			...
			<div class="mod mod1">
				<div class="mod-header radius clearfix">
					<h2>
						Top 10 运营商<a class="icon help poptips" action-frame="tip_carriers" title=""></a>
					</h2>
				</div>
				<div class="mod-body">
					<div class="content">
			...
			<div class="">
				<div id="tip_device">
					<div id="tip_carriers" class="tips">
						<div class="corner"></div>
						<p>您可以查看在指定日期内(活跃用户、启动次数)运营商的分布情况。</p>
					</div>
				</div>
			</div>
		</div>
