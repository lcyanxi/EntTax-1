...
<div class="bd clearfix">
	...
	<div id="mainContainer">
		<div class="contentCol">
			<input type="hidden" value="devices_devices" id="action_stats" />
						...
						<div class="mod-select">
							<div class="tabpanel">
								<ul id="toptab" class="borders">
									<li class=on><a href="/terminal/device.do?appId=${globalAppid }&which=devices">机型</a></li>
			...
			<div class="mod mod1">
				<div class="mod-header radius clearfix">
					<h2>
						Top 10 机型<a class="icon help poptips" action-frame="tip_devices" title=""></a>
					</h2>
				</div>
				<div class="mod-body">
					<div class="content">
			...
			<div class="">
				<div id="tip_device">
					<div id="tip_devices" class="tips">
						<div class="corner"></div>
						<p>您可以查看在指定日期内(活跃用户、启动次数)用户机型的分布情况。</p>
					</div>
				</div>
			</div>
		</div>
