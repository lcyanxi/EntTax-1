...
<div class="bd clearfix">
	...
	<div id="mainContainer">
		<div class="contentCol">
			<input type="hidden" value="devices_versions" id="action_stats" />
						...
						<div class="mod-select">
							<div class="tabpanel">
								<ul id="toptab" class="borders">
									...
									<li class=><a href="/terminal/device.do?appId=${globalAppid }&which=resolutions">分辨率</a></li>
									<li class=on><a href="/terminal/device.do?appId=${globalAppid }&which=system">操作系统</a></li>
								</ul>
							</div>
						</div>
					</div>
			...
			<div class="mod mod1">
				<div class="mod-header radius clearfix">
					<h2>
						Top 10 操作系统<a class="icon help poptips"
							action-frame="tip_versions" title=""></a>
					</h2>
				</div>
				<div class="mod-body">
					<div class="content">
			...
			<div class="">
				<div id="tip_device">
					<div id="tip_versions" class="tips">
						<div class="corner"></div>
						<p>您可以查看在指定日期内(活跃用户、启动次数)操作系统的分布情况。</p>
					</div>
				</div>
			</div>
		</div>
