			...
			<div class="wrap-table">
				<div class="mod mod1 parent-table" id="active_user-detail-table">
					<div class="mod-header radius">
						<h2>
							关键词排名 <a class="icon help poptips"
					...
					<div class="mod-body " id="data-load">
						<table class="data-load " width="100%" border="0" cellspacing="0">
							...
							<tbody id="data-list">
								<c:forEach items="${rowlst}" var="userbehavior" varStatus="st">
									<tr>
										<td><c:out value="${st.count}"/></td>
										<td><c:out value="${userbehavior.keyword}" /></td>
										<td><a title="点一下又不会怀孕,^_^" href="/user/behavior/keyword/detaillist.do?qtype=${qtype}&keyword=${userbehavior.keyword}"><c:out value="${userbehavior.counts}" /></a></td>
									</tr>
								</c:forEach>
							</tbody>
						</table>
