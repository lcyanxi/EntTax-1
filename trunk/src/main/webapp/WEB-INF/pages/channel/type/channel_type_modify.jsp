...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	...
	<body>
              ...
              %>
                      <form method="post" name="functioninfo_modify" id="modify" action="/channel/type/update.do" title='' style="width:550px;margin:0px;"> 
                          <fieldset> 
                              <legend>渠道管理</legend> 
                              <table> 
                                       <tbody> 
                                           <tr>
                                                 <td> Id:</td> 
                                                 <td>
                                                 	<input type="text" name="id" readonly="readonly" value="${channelType.id}" />
                                                 	<input type="hidden" name="level" readonly="readonly" value="${channelType.level}" />
                                                 </td> 
                                           </tr> 
                                           <c:if test="${channelType.level > 1 }">
                                           <tr>
                                                  <td>&nbsp;</td>
                                           </tr>
                                           <tr> 
                                                 ...
                                                 <td>
                                                 	<select name="parentId">
														<c:forEach items="${parentList}" var="parentType">
															<option <c:if test="${parentType.id == channelType.parentId}">selected</c:if> value="${parentType.id}">${parentType.typeName}</option>
														</c:forEach>							
													</select>
                                                 </td> 
                                           </tr> 
                                           ...
                                           <tr> 
                                                 <td> 类别名称:</td> 
                                                 <td>
                                                 	<input type="text" name="typeName" value="${channelType.typeName}" />
                                                 </td>
                                           </tr>
                                           <tr>
                                                  <td>&nbsp;</td>
                                           ...
                                           <tr> 
                                                 <td> 排序:</td> 
                                                 <td><input type="text" name="sort" value="${channelType.sort}" /></td> 
                                           </tr> 
                                           <tr>
                                                  <td>&nbsp;</td>
                                           </tr>
                                           <tr> 
                                                 <td> 时间:</td>
                                                 <td><input type="text" name="createTime" readonly="readonly" value="${channelType.createTime}" /></td> 
                                           </tr>
                                            <tr>
                                                  <td>&nbsp;</td>
                                           </tr>
                                           <tr>
                                                 <td> 描述:</td> 
                                                 <td><input type="text" name="typeDesc" value="${channelType.typeDesc}" /></td> 
                                           </tr>
                                           <tr>
