...
<body>
	...
	<form method="post" name="functioninfo_add" id="add"
		action="/channel/cooperation/insert.do" title=''
		...
		<fieldset>
			<table>
				<tbody>
					...
					<tr>
						<td>描述:</td>
						<td colspan="3"><input type="text" name="cooperationDesc" /></td>
					</tr>
					<tr>
		...
		$(document).ready(
				function() {
					jQuery("#tb_function").jqGrid(
							{
								url : '/channel/cooperation/queryJson.do?level=${level}',
								datatype : "json",
								colNames : [ 'Id', '名称', '排序',
										'描述', '创建时间', '修改' ],
								colModel : [ {
