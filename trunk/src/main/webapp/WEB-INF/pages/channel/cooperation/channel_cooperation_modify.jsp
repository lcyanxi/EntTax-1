...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	...
	<body>
              ...
              %>
                      <form method="post" name="functioninfo_modify" id="modify" action="/channel/cooperation/update.do" title='' style="width:550px;margin:0px;"> 
                          <fieldset> 
                              <legend>渠道合作管理</legend> 
                              <table> 
                                       <tbody> 
                                           <tr>
                                                 <td> Id:</td> 
                                                 <td>
                                                 	<input type="text" name="id" readonly="readonly" value="${channelCooperation.id}" />
                                                 </td> 
                                           </tr> 
                                           <tr>
                                                  <td>&nbsp;</td>
                                           ...
                                           <tr> 
                                                 <td> 渠道合作名称:</td> 
                                                 <td>
                                                 	<input type="text" name="cooperationName" value="${channelCooperation.copName}" />
                                                 </td>
                                           </tr>
                                           <tr>
                                                  <td>&nbsp;</td>
                                           ...
                                           <tr> 
                                                 <td> 排序:</td> 
                                                 <td><input type="text" name="sort" value="${channelCooperation.sort}" /></td> 
                                           </tr> 
                                           <tr>
                                                  <td>&nbsp;</td>
                                           </tr>
                                           <tr> 
                                                 <td> 时间:</td>
                                                 <td><input type="text" name="createTime" readonly="readonly" value="${channelCooperation.createTime}" /></td> 
                                           </tr>
                                            <tr>
                                                  <td>&nbsp;</td>
                                           </tr>
                                           <tr>
                                                 <td> 描述:</td> 
                                                 <td><input type="text" name="cooperationDesc" value="${channelCooperation.copDesc}" /></td> 
                                           </tr>
                                           <tr>
