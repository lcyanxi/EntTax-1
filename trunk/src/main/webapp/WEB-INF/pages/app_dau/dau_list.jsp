						...
						<table class="data-load " width="100%" border="0" cellspacing="0">
							...
							<tbody id="data-list">
								<c:forEach items="${rowlst}" var="appdau">
									<tr>
										<td>
										     <c:if test="${appdau.app==3}">iOS</c:if>
                                             <c:if test="${appdau.app==4}">Android</c:if>
                                             <c:if test="${appdau.app==2}">ipad</c:if>
										</td>
										...
										<td><c:out value="${appdau.logins}" /></td>
			...
			function() {
				...
				global.renderPage = function() {
					...
					if (startDateShow != $("#startDate").val()
						...
						window.location.href = "/appdau/daulist.do?startDate="
