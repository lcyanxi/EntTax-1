...
<%@ page import="com.qunar.menu.Tree" %>
...
<%
	...
	try {
		...
		if(strType != null && "menu".equals(strType)){
			strMenuSQL += " and m.visiable = 1";
		}
               	String strUserFunctionSQL = "select `userID`,`functionID` from `userfunctions` where userID = '" + strUserId + "'";
