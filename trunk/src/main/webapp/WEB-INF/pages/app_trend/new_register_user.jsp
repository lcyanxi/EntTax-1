            ...
            <div class="wrap-table">
                <div class="mod mod1 parent-table" id="active_user-detail-table">
                    <div class="mod-header radius">
                        <h2>
                             新增注册用户来源明细<a class="icon help poptips" action-frame="tip_activeTable"
                                   title=""></a>
                        </h2>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        global.renderPage = function() {
            ...
            {
                window.location.href="/trends/register_user_type.do?startDate="+startDateShow+"&endDate="+endDateShow+"&type="+type;
            }
        }
    });
</script>
