                        ...
                        <div class="mod-select">
                            <div class="tabpanel">
                                <ul id="toptab" class="borders">
                                    ...
                                    <li class=<c:if test="${type == 'month'}"> on</c:if>><a href="/trends/register_month_user.do?startDate=${startDate}&endDate=${endDate}&type=month">月统计</a></li>></li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div class="wrap-table">
                <div class="mod mod1 parent-table" id="active_user-detail-table">
                    <div class="mod-header radius">
                        <h2>
                            月新增注册用户明细 <a class="icon help poptips" action-frame="tip_activeTable" title=""></a>
                        </h2>
        ...
        function() {
            ...
            global.renderPage = function() {
                ...
                if (startDateShow != $("#startDate").val()
                    ...
                    window.location.href = "/trends/register_month_user.do?startDate="
