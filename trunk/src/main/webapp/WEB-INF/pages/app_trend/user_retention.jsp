...
<div class="bd clearfix">
	...
	<div id="mainContainer" style="margin-left: 0px;">
		<div class="contentCol">
			<input type="hidden" value="retentions" id="action_stats" />
...
<script id="tmplTable" type="text/x-jquery-tmpl">
  <tr>
    ...
    <td class="colorGrad\${colorGrad(retention_rate[9])}">\${retention_rate[9]} {{if retention_rate[9] != null}}%{{else}}--{{/if}}</td>
    <td class="colorGrad\${colorGrad(retention_rate[10])}">\${retention_rate[10]} {{if retention_rate[10] != null}}%{{else}}--{{/if}}</td>
    <td class="colorGrad\${colorGrad(retention_rate[11])}">\${retention_rate[11]} {{if retention_rate[11] != null}}%{{else}}--{{/if}}</td>
  </tr>
</script>
