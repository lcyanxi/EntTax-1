...
<div class="bd clearfix">
	...
	<div id="mainContainer" style="margin-left: 0px;">
		<div class="contentCol">
			<input type="hidden" value="origin_retentions" id="action_stats" />
					...
					<div class="mod-body">
						<table id="retention-table" class="data-load" width="100%"
							...
							<thead>
								...
								<tr id="weekly_after_period" class="after_period_indicator hidden">
									<th colspan="2"></th>
									<th>1周后</th>
									<th>2周后</th>
									<th>3周后</th>
								...
								<tr id="monthly_after_period" class="after_period_indicator hidden">
									<th colspan="2"></th>
									<th>1月后</th>
									<th>2月后</th>
									<th>3月后</th>
