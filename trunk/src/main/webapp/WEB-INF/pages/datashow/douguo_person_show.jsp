...
<head>
    ...
    <style type="text/css">
        *{padding: 0; margin: 0;}
        ...
        /*数字滚动插件的CSS可调整样式*/
        .mt-number-animate{ font-family: '微软雅黑'; line-height:40px;
            height: 40px;/*设置数字显示高度*/; font-size: 36px;/*设置数字大小*/ overflow: hidden; display: inline-block; position: relative; }
        ...
        .top-center-top{font-size:0; color: #fff;text-align: center}
        .top-center-top h3,.top-center-top .numberRun2{ display: inline-block;}
        .top-center-top h3{ line-height: 53px;
            height: 53px;
            font-size: 18px;
            position: relative;
            top: -12px;}
    ...
    <div class="wrap">
        <div class="top clearfix">
            ...
            <div class="top-center left">
                <div class="top-center-top"><h3>当日累计在线人数：</h3><div class="numberRun2"></div> </div>
                <div id="indexsrh1"></div>
            </div>
...
<script src="/datashow/echarts3-7/myNumShow.js"></script>
...
<script type="text/javascript">
    //数字初始化
    var numRun2 = $(".numberRun2").numberAnimate({num:'53432', speed:2000, symbol:","});
    ...
    function getNumData() {
        $.get("/datashow/numData.do",function(msg){
            numRun2.resetData(msg.numData);
        });
