						...
						<div class="mod-select">
							<div class="tabpanel">
								<ul id="toptab" class="borders">
									<li class=<c:if test="${source == 0}"> on</c:if>><a href="/cooklevel/cllist.do?startDate=${startDate}&endDate=${endDate}&source=0">菜谱统计</a></li>
								</ul>
							</div>
						</div>
					</div>
...
$(document).ready(function(){
	...
	global.renderPage = function() {
		...
		{
			window.location.href="/cooklevel/cllist.do?startDate="+startDateShow+"&endDate="+endDateShow+"&source="+source;
		}		
	}
});
</script>
